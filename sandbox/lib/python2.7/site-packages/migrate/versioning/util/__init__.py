#!/usr/bin/env python
# -*- coding: utf-8 -*-
""".. currentmodule:: migrations.versioning.util"""
...
def construct_engine(engine, **opts):
    ...
    Currently, there are 2 ways to pass create_engine options to :mod:`migrations.versioning.api` functions:
    ...
    :param engine_arg_*: keyword parameters to pass to `create_engine` (evaluated with :func:`migrations.versioning.util.guess_obj_type`)
...
def with_engine(f, *a, **kw):
    """Decorator for :mod:`migrations.versioning.api` functions
