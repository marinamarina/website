...
class Repository(pathed.Pathed):
    ...
    def verify(cls, path):
        ...
        :raises: :exc:`InvalidRepositoryError <migrations.exceptions.InvalidRepositoryError>`
        """
    ...
    def create_script(self, description, **k):
        """API to :meth:`migrations.versioning.version.Collection.create_new_python_version`"""
    ...
    def create_script_sql(self, database, description, **k):
        """API to :meth:`migrations.versioning.version.Collection.create_new_sql_version`"""
        k['use_timestamp_numbering'] = self.use_timestamp_numbering
        self.versions.create_new_sql_version(database, description, **k)

    @property
    def latest(self):
        """API to :attr:`migrations.versioning.version.Collection.latest`"""
    ...
    def version(self, *p, **k):
        """API to :attr:`migrations.versioning.version.Collection.version`"""
    ...
    def changeset(self, database, start, end=None):
        """Create a changeset to migrations this database from ver. start to end/latest.
    ...
    def create_manage_file(cls, file_, **opts):
        ...
        :param opts: Options that are passed to :func:`migrations.versioning.shell.main`
        """
