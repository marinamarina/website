...
class PythonScript(base.BaseScript):
    ...
    def create(cls, path, **opts):
        ...
        :returns: :class:`PythonScript instance <migrations.versioning.script.py.PythonScript>`"""
    ...
    def make_update_script_for_model(cls, engine, oldmodel,
        ...
        :param repository: path to migrations repository
        ...
        :type repository: string or :class:`Repository instance <migrations.versioning.repository.Repository>`
    ...
    def verify_module(cls, path):
        ...
        :type path: string
        :raises: :exc:`InvalidScriptError <migrations.exceptions.InvalidScriptError>`
    ...
    def preview_sql(self, url, step, **args):
        ...
        and runs :meth:`PythonScript.run <migrations.versioning.script.py.PythonScript.run>`
    ...
    @property
    def module(self):
        """Calls :meth:`migrations.versioning.script.py.verify_module`
        and returns it.
        """
