...
class _MigrateConfig(object):
    ...
    @property
    def metadata(self):
        """Backwards compatibility, in old releases app.extensions['migrations']
        was set to db, and env.py accessed app.extensions['migrations'].metadata"""
...
class Migrate(object):
    ...
    def init_app(self, app, db, directory = 'migrations'):
        if not hasattr(app, 'extensions'):
            app.extensions = {}
        app.extensions['migrations'] = _MigrateConfig(db, directory)
...
def _get_config(directory):
    if directory is None:
        directory = current_app.extensions['migrations'].directory
